# What Does G15Stats Do?

G15Stats is a statistics monitoring application for G15 LCD displays. It
provides real-time monitoring of system resources and displays them on the
G15 keyboard's LCD screen.
...
For a detailed breakdown of every screen and mode with screenshots, see the
[Screens](screens.md) page in the User guide.
