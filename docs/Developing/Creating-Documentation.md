...
One of the goals of the G15Stats project is to enable users to get all of the
...
- Find the relevant directory to store your new document in (`docs/`).
...
- URLs can be made `[like this](https://www.g15stats.org)`.
...
distribution: `mkdocs.yml`. The various configuration directives
